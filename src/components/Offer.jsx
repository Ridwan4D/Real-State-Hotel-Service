...
//   console.log(offer);
  ...
  return (
    <div>
      <div className="rounded-lg shadow-md border-2 border-gray-500 dark:bg-gray-50 dark:text-gray-800">
        ...
        <img
          src={image}
          alt=""
          className="object-contain object-center w-full h-72 dark:bg-gray-500"
        />
        <div className="p-3">
          ...
          <div>
            ...
            <div className="flex">
              ...
              <small><del>{previousPrice}</del></small>
            </div>
