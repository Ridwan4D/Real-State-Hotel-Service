    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 my-5">
          <div className="flex flex-col justify-center p-6 shadow-lg border-2 border-slate-300 rounded-xl sm:px-12">
            <img
            ...
            <div className="space-y-4 text-center divide-y dark:divide-gray-300">
              ...
              <div className="flex justify-center pt-2 space-x-4 align-center">
                <a
                  ...
                  href="#"
                  aria-label="GitHub"
                  className="p-2 rounded-md dark:text-gray-800 hover:dark:text-default-600"
                >
                  <svg
                    viewBox="0 0 496 512"
